...
def LoadSpecificSlug(slug):
    """ function docstring """
    log(f"default.LoadSpecificSlug - Slug: {slug}")
    navig.AddItemInMenu(content.LoadSpecificSlugContent(slug, filtres))
    xbmc.executebuiltin('Container.SetViewMode(500)') # "List" view.
    log("default.LoadSpecificSlugExit")
...
elif MODE == 3: # Mode pour charger le slug spécifique
    LoadSpecificSlug(URL)
